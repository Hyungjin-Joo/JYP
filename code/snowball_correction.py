...
if __name__=="__main__":
    ...
    for f in uncal_list:
        os.system('strun /Volume/Metal_Empire_001/JWST/code/detector1_uncal.params %s'%f)
    ...
    for f in ramp_list:
        ...
        os.system('strun /Volume/Metal_Empire_001/JWST/code/detector1_ramp.params %s'%f)